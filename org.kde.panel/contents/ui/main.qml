...
Rectangle {
    ...
    color: Plasmoid.location === PlasmaCore.Types.TopEdge ? "transparent" : Qt.rgba(1, 1, 1, 0.1)
    border.color: Plasmoid.location === PlasmaCore.Types.TopEdge ? "transparent" : Qt.rgba(1, 1, 1, 0.3)
